...
def process_document(front_image_path: str, back_image_path: str, iterations=500) -> dict:
    """ 
    ...
    try:
        ...
        for _ in range(iterations):
            ...
            # Guardar resultados de cada iteración
            for key in front_results:
                front_results[key].append(front_data[key])
            for key in back_results:
                back_results[key].append(back_data[key])
