...
def scan_document(output_path_front: str, output_path_back: str) -> None:
    ...
    try:
        ...
        image_front = wia_dialog.ShowAcquireImage(WIA_DEVICE_TYPE_SCANNER, WIA_FORMAT_BMP)
        ...
        image_back = wia_dialog.ShowAcquireImage(WIA_DEVICE_TYPE_SCANNER, WIA_FORMAT_BMP)
