...
def scan_document(output_path_front: str, output_path_back: str) -> None:
    """
    Escanea las partes frontal y trasera de un documento utilizando WIA y guarda las imágenes como PNG.
    ...
    try:
        ...
        # Escanear la parte frontal
        print("Escaneando la parte frontal del documento...")
        item = device.Items[0]
        ...
        # Escanear la parte trasera
        print("Escaneando la parte trasera del documento...")
        ...
        if bmp_image_front is None or bmp_image_back is None:
            raise Exception("No se pudo cargar una o ambas imágenes temporales.")
